...
<div id="location" className="loc-card scroll-mt-10 flex flex-col pl-5 pr-5 md:pl-2 md:pr-5 md:pb-3 md:pt-5 md:gap-3 gap-1 w-full">
  <div className="loc-text md:p-50 p-5">
          <h1 className="text-4xl leading-relaxed order-0 md:order-0" >Location</h1>
        <h3 className="text-xl font-light leading-relaxed order-1 md:order-2" >Minni-Vellir, is a beautiful, recently renovated, farmhouse full of history and charm.  
  ...
  <div className="loc-image md:h-120 md:order-1 w-full md:px-20">
